...
/*   Updated: 2023/11/29 17:43:20 by heda-sil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	ft_init(&g);
	mlx_mouse_hide(g.mlx, g.mlx_window); // TMP: Decide if it stays here or mouse function, here hides the mouse from the beggining, seems right
